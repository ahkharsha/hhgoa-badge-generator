  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start pt-4 border-t border-brand-accent/20">
        ...
        <div className="space-y-6 bg-black/20 p-5 rounded-xl border border-brand-accent/20 h-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start pt-6 border-t border-brand-accent/30">
